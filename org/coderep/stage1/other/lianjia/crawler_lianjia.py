...
if __name__ == '__main__':
    ...
    for district in districts.find_all(name='a'):
        ...
        for j in range(1, total_pages+1):
            ...
            if not sells:
                continue
            # <a class="title" data-bl="list" data-elu="ershoufang" data-log_index="1" href="XX" target="_blank">
            ...
            for i in range(N):
                ...
                print region, room_type, area, price, unit_price, tax, orientation, decoration, elevator, floor, year, slab_tower
